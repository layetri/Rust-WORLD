...
pub fn cheaptrick(x: &[f64], fs: i32, temporal_positions: &[f64], f0: &[f64], option: &mut CheapTrickOption) -> Vec<Vec<f64>> {
...
pub fn decode_aperiodicity(coded_aperiodicity: &[Vec<f64>], f0_length: i32, fs: i32) -> Vec<Vec<f64>> {
    let mut cheaptrick_option = CheapTrickOption::new(fs);
    unsafe {
	GetFFTSizeForCheapTrick(fs, &mut cheaptrick_option as *mut _);
    }
...
pub fn code_spectral_envelope(spectrogram: &[Vec<f64>], f0_length: i32, fs: i32, fft_size: i32, number_of_dimensions: i32) -> Vec<Vec<f64>> {
...
pub fn decode_spectral_envelope(coded_spectrogram: &[Vec<f64>], f0_length: i32, fs: i32, fft_size: i32) -> Vec<Vec<f64>> {
...
pub fn d4c(x: &[f64], fs: i32, temporal_positions: &[f64], f0: &[f64], option: &D4COption) -> Vec<Vec<f64>> {
